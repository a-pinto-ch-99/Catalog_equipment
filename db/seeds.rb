...
category.sub_categories << SubCategory.create(name: 'Sub Category 1')
category.sub_categories << SubCategory.create(name: 'Sub Category 2')
category.sub_categories << SubCategory.create(name: 'Sub Category 3')
